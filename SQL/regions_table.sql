...
Select R.region_id , Count(*) from REGIONS as R INNER JOIN COUNTRIES as C ON R.region_id = C.REGION_ID GROUP BY R.REGION_ID ;

--Display Countries where  NO of Locations are present
Select C.COUNTRY_ID , Count(*) from COUNTRIES as C INNER JOIN LOCATIONS as L ON C.COUNTRY_ID = L.COUNTRY_ID GROUP BY C.COUNTRY_ID ;
